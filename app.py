...
input_data = {
    "Rotational speed [rpm]": st.sidebar.number_input(
    "Rotational speed [rpm]", key="rotational_speed"
),
"Torque [Nm]": st.sidebar.number_input(
    "Torque [Nm]", key="torque"
),
"Tool wear [min]": st.sidebar.number_input(
    "Tool wear [min]", key="tool_wear"
),
"TWF": st.sidebar.number_input(
    "TWF", key="twf"
),
"HDF": st.sidebar.number_input(
    "HDF", key="hdf"
),
"PWF": st.sidebar.number_input(
    "PWF", key="pwf"
),
"OSF": st.sidebar.number_input(
    "OSF", key="osf"
),
}
